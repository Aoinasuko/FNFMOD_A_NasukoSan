	...
	public function new(x:Float, y:Float, ?character:String = "bf", ?isPlayer:Bool = false)
	{
		...
		switch (curCharacter)
		{
			case 'bf':
				...
				flipX = true;
			case 'a_nasuko':
				frames = Paths.getSparrowAtlas('A_nasuko/a_nasuko');
				animation.addByPrefix('idle', 'a_nasuko stand', 24, false);
				animation.addByPrefix('singUP', 'a_nasuko up', 24, false);
				animation.addByPrefix('singDOWN', 'a_nasuko down', 24, false);
				animation.addByPrefix('singLEFT', 'a_nasuko left', 24, false);
				animation.addByPrefix('singRIGHT', 'a_nasuko right', 24, false);
