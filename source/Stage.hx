	...
	public function new(daStage:String)
	{
		...
		switch (daStage)
		{
			...
			case 'nasuko_noon':
				{
					camZoom = 0.9;
					var Sky:FlxSprite = new FlxSprite(-600, -200).loadGraphic(Paths.loadImage('song1/Sky', 'week1'));
					...
					var Ground:FlxSprite = new FlxSprite(-600, -200).loadGraphic(Paths.loadImage('song1/Ground', 'week1'));
			...
			case 'nasuko_evening':
				{
					camZoom = 0.9;
					var Sky:FlxSprite = new FlxSprite(-600, -200).loadGraphic(Paths.loadImage('song2/Sky', 'week1'));
					Sky.antialiasing = FlxG.save.data.antialiasing;
					Sky.scrollFactor.set(0.9, 0.9);
					Sky.active = false;
					swagBacks['sky'] = Sky;
					...
					var Ground:FlxSprite = new FlxSprite(-600, -200).loadGraphic(Paths.loadImage('song2/Ground', 'week1'));
					Ground.antialiasing = FlxG.save.data.antialiasing;
					Ground.scrollFactor.set(0.9, 0.9);
					Ground.active = false;
					swagBacks['ground'] = Ground;
			...
			case 'nasuko_night':
				{
					camZoom = 0.9;
					var Sky:FlxSprite = new FlxSprite(-600, -200).loadGraphic(Paths.loadImage('song3/Sky', 'week1'));
					Sky.antialiasing = FlxG.save.data.antialiasing;
					Sky.scrollFactor.set(0.9, 0.9);
					Sky.active = false;
					swagBacks['sky'] = Sky;
					...
					var Ground:FlxSprite = new FlxSprite(-600, -200).loadGraphic(Paths.loadImage('song3/Ground', 'week1'));
					Ground.antialiasing = FlxG.save.data.antialiasing;
					Ground.scrollFactor.set(0.9, 0.9);
					Ground.active = false;
					swagBacks['ground'] = Ground;
